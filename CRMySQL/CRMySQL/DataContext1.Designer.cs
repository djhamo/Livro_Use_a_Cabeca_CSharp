...
// Code is generated on: 22/09/2014 13:36:45
//
...
namespace CrmDemoContext
{
    ...
    {
        public static CompiledQueryCache compiledQueryCache = CompiledQueryCache.RegisterDataContext(typeof(CrmDemoDataContext));
        ...
        public CrmDemoDataContext(MappingSource mappingSource) :
        base(GetConnectionString("CrmDataContextConnectionString"), mappingSource)
        {
            OnCreated();
        }
        ...
        public CrmDemoDataContext(string connection, MappingSource mappingSource) :
            base(connection, mappingSource)
        {
          OnCreated();
        }

        public CrmDemoDataContext(System.Data.IDbConnection connection, MappingSource mappingSource) :
            base(connection, mappingSource)
        {
          OnCreated();
        }
