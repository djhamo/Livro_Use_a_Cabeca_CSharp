...
namespace HexDumper
{
    class Program
    {
        ...
        {
            string arg = @"C:\Users\tiago\Documents\Projetos\VStudioTiago\HexDumper\HexDumper\bin\Debug\HexDumper.pdb";
/*
            if (args.Length != 1)
            {
                Console.Error.WriteLine("usage: fexdumper file-to-dump");
            ...
            */
            ...
            using (Stream input = File.OpenRead(arg))
            {
                int position = 0;
