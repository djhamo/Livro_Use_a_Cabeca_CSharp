...
namespace myBinaryWriter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (FileStream output = File.Create("binarydate.dat")) 
            ...
            byte[] dataWritten = File.ReadAllBytes("binarydate.dat");
            ...
            using (FileStream input = File.OpenRead("binarydate.dat"))
            using (BinaryReader reader = new BinaryReader(input))
            {
                ...
                Console.Write("floar: {0} char: {1}", floatRead, charRead);
            }
            Console.ReadKey();
